...
-
 ...
 - **Modèles Retenus** : `LightGradientBoostingClassifier`, `Word2Vec DNN` Avec `Keras`
 - **Spécificités du Modèle `LightGradientBoostingClassifier`** : **Dispose** du net **avantage** d'être **~6** fois plus rapide que le GradientBoostingClassifier à 
 ...
 et donc tout en améliorant sa **généralisation** sur l'ensemble de test'''
  ...
  '''
 - Spécifictiés du Modèle `Word2Vec` : Réseau **DNN** constitué d'1 couche d'`Embedding` en charge de capturer les **relations** entre les mots dans un espace **dense** 
 ...
 des dimensions de la **matrice des embeddings**, la **profondeur** du dictionnaire du **vocabulaire**, le choix de l'algorithme 
 de la **descente du gradient** et le choix des paramètres de l'enrainement `{batch_size, epochs, validation_split}`: cette dernière a essentiellement consisté en un 
...
#### `Script d'optimisation des paramètres d'entraînement du modèle` Word2Vec'''
  st.code('''
  param_grid = {"batch_size": [64, 128, 256], "epochs" : [10, 20, 30, 45, 50], "validation_split": [0.1, 0.15, 0.2]}
...
best["best_loss"] = min_loss''')
  ...
  '''#### `Rapport de classification du modèle` LightGradientBoostingClassifier'''

  st.write("`Accuracy Score` des documents sur l'ensemble de **Test** : **74.67%**")
  '''
  `class          precision    recall     f1-score    support`  
  `-----          ---------    ------     --------   --------`\n
  `10               0.27        0.79        0.40       2047`\n
  `40               0.65        0.52        0.58       2047`\n
  `50               0.75        0.68        0.72       2047`\n
  `60               0.91        0.85        0.88       2047`\n
  `1140             0.72        0.74        0.73       2047`\n
  `1160             0.85        0.83        0.84       2047`\n
  `1180             0.79        0.62        0.70       2047`\n
  `1280             0.60        0.52        0.56       2047`\n
  `1281             0.59        0.51        0.55       2047`\n
  `1300             0.94        0.90        0.92       2047`\n
  `1301             0.96        0.92        0.94       2047`\n
  `1302             0.89        0.77        0.82       2047`\n
  `1320             0.72        0.67        0.69       2047`\n
  `1560             0.74        0.76        0.75       2047`\n
  `1920             0.87        0.89        0.88       2047`\n
  `1940             0.90        0.84        0.87       2047`\n
  `2060             0.77        0.71        0.74       2047`\n
  `2220             0.87        0.84        0.85       2047`\n
  `2280             0.75        0.68        0.71       2047`\n
  `2403             0.73        0.63        0.68       2047`\n
  `2462             0.73        0.75        0.74       2047`\n
  `2522             0.87        0.82        0.85       2047`\n
  `2582             0.76        0.68        0.71       2047`\n
  `2583             0.91        0.91        0.91       2047`\n
  `2585             0.80        0.72        0.76       2047`\n
  `2705             0.81        0.61        0.70       2047`\n
  `2905             0.99        0.98        0.99       2047`\n
  `                                                         `\n
  `accuracy                                 0.75       55269`\n
  `macro avg        0.78        0.75        0.76       55269`\n
  `weighted avg     0.78        0.75        0.76       55269`\n



  '''#### `Rapport de classification du modèle` Word2Vec'''
